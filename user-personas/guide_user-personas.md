# Writing Guide: User Personas

>Before using [Template: User Personas](./template_user-personas.md), read this for guidance on how to fill in this template.
...
Want to see best practices and further considerations about demographics when it comes to attributes for your user personas? Refer to the [Best Practices guide](practices_user-personas.md).
