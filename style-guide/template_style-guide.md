...
> If you need more information about how to fill in this template, read the accompanying [guide](./guide_style-guide.md).
>
...
This project recommends using the following templates:
