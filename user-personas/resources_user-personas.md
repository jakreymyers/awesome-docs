# Resources: User Personas

>Before using [Template: User Personas](./template_user-personas.md), read this to see high quality examples of the template in action and to review the resources that were consulted when this template was created.
