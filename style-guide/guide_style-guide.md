# Writing Guide: Style Guide

>Before using [Template: Style Guide](./template_style-guide.md), read this for guidance on how to fill in this template.
...
This template collection provides templates for various types of topics that you
can adopt in your project. Depending on the type of project you're creating,
some templates will be more relevant than others. In this
